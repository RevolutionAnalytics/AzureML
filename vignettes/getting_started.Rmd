...
api <- updateWebService(
  ...
  serviceId = api$WorkspaceId   # <<-- Required to update!
)
```
...
From a given service, use the `endpoints()` function to list the AzureML
...
might be different that what you observe locally. This is generally only an
